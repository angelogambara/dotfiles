...
static const Key keys[] = {
	...
	{ Mod4Mask, XK_s, spawn, COMMAND("sxiv -P '' -ro gallery-dl") },
	{ Mod4Mask|ShiftMask, XK_s, spawn, COMMAND("sxiv -P '' -ro gallery-dl") },
	...
	{ 0, XK_F1, spawn, COMMAND("pactl set-sink-mute @DEFAULT_SINK@ toggle") },
	{ 0, XK_F2, spawn, COMMAND("pactl set-sink-volume @DEFAULT_SINK@ -5%") },
	{ 0, XK_F3, spawn, COMMAND("pactl set-sink-volume @DEFAULT_SINK@ +5%") },
